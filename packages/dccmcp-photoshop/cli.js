#!/usr/bin/env node
/**
 * dccmcp-photoshop — MCP server for Photoshop
 *
 * This package name is reserved by DCCMCP. The integration is not released yet.
 * Docs and release status: https://dccmcp.com/mcp-for-photoshop
 */
...
const SOFTWARE = "Photoshop";
const DOCS = "https://dccmcp.com/mcp-for-photoshop";
