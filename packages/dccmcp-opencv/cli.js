#!/usr/bin/env node
/**
 * dccmcp-opencv — MCP server for OpenCV
 *
 * This package name is reserved by DCCMCP. The integration is not released yet.
 * Docs and release status: https://dccmcp.com/mcp-for-opencv
 */
...
const SOFTWARE = "OpenCV";
const DOCS = "https://dccmcp.com/mcp-for-opencv";
